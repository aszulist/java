...
//        people.forEach(System.out::println);
        ...
        System.out.println("People form Paris: " + map.getOrDefault(paris, Collections.EMPTY_LIST));
        System.out.println("People form New York: " + map.getOrDefault(newYork, Collections.EMPTY_LIST));
